...
<div id="buttons">
  <a href="#">&laquo;</a>
  <button class="button1" onclick="show(currentpage)">1</button>
  <button onclick="show(currentpage)">2</button>
  <button onclick="show(currentpage)">3</button>
  <button onclick="show(currentpage)">4</button>
  <button onclick="show(currentpage)">5</button>
  <button onclick="show(currentpage)">6</button>
  <button onclick="show(currentpage)">7</button>
  <button onclick="show(currentpage)">8</button>
  <button onclick="show(currentpage)">9</button>
  <button onclick="show(currentpage)">10</button>
  <a href="#">&raquo;</a>
...
const noofpages = Math.ceil(arraylength/itemsperpage);
...
function show(currentpage) {
    ...
    function page(currentpage) {
      ...
      const itemsofpage = array.slice(start, stop);
